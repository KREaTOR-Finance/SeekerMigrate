import { Button, Card, Checkbox, H2, Input, Paragraph, Select, XStack, YStack } from 'tamagui';
  ...
  return (
    <YStack flex={1} padding="$5" gap="$4">
      ...
      <Paragraph opacity={0.85}>
        SMNS is the SeekerMigrate Name Service. Optional SNS mirror will publish under <Paragraph fontWeight="700">*.seekermigrate.sol</Paragraph>.
      </Paragraph>
      ...
      <Card padded elevate>
        <YStack gap="$3">
          ...
          <Button theme="active" onPress={handleLookup}>
            Check availability
          </Button>
            ...
            <YStack gap="$2">
              ...
              {lookupResult.available ? (
                <YStack gap="$2" paddingTop="$2">
                  ...
                  <Button theme="active" disabled={!wallet.connected} onPress={handlePayAndRegister}>
                    Pay & Register
                  </Button>
                  {registerStatus ? <Paragraph opacity={0.8}>{registerStatus}</Paragraph> : null}

                  {paymentSig ? (
                    <Button size="$3" onPress={() => Linking.openURL(explorerTxUrl(paymentSig, cluster))}>
                      View payment tx
                    </Button>
                  ) : null}
      ...
      <Card padded elevate>
        <YStack gap="$3">
          ...
          <Button theme="active" disabled={!wallet.connected || !vanityValidation.ok || vanityLoading} onPress={handleVanityRequest}>
                ...
                <YStack gap="$2">
                  ...
                  <XStack gap="$2" alignItems="center">
                    <Checkbox
                      ...
                      onCheckedChange={(v) => setVanityAckReveal(!!v)}
                    />
                  ...
                  <Button size="$3" theme="active" onPress={handleVanityReveal} disabled={!vanityAckReveal}>
